...
namespace Carvers.Charting.MultiPane
{
    public class CreateMultiPaneStockChartsViewModel : ViewModel
    {
            ...
            IObservable<IEvent> eventsFeed = null)
        {
            ...
            ChartPaneViewModels = new ObservableCollection<BaseChartPaneViewModel>();
            ...
            PricePaneViewModel.ConstructPricePaneViewModel(this, candleFeed, eventsFeed)
                .ContinueWith(t =>
                {
                    t.Result.ViewportManager = _viewportManager;
                    t.Result.IsFirstChartPane = true;
                    ChartPaneViewModels.Add(t.Result);

                    chartFeeds
                        .ForEach(chart => ChartPaneViewModels.Add(new RsiPaneViewModel(this, chart)
        ...
        public ObservableCollection<BaseChartPaneViewModel> ChartPaneViewModels { get; private set; }
